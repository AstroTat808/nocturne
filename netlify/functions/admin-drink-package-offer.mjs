...
export default async (req) => {
  ...
  const text = [
    ...
    'Refund policy: refundable only before the first drink credit is redeemed. Once any drink is redeemed, the package is non-refundable and no prorated refund is available.', '',
    'NOCTURNE Festival', 'Presented by Wild Ones · Hawai‘i'
  ].join('\n');
  const html = `<!doctype html><html><body style="margin:0;background:#030303;color:#f7efe3;font-family:Arial,sans-serif"><div style="max-width:640px;margin:0 auto;padding:44px 24px"><div style="border:1px solid rgba(216,154,43,.35);background:#080604;padding:38px 30px"><div style="color:#d89a2b;font-size:11px;letter-spacing:3px;text-transform:uppercase">NOCTURNE · Optional Bar Add-On</div><h1 style="font-family:Georgia,serif;font-weight:400;font-size:42px;line-height:1.04;color:#fff3df;margin:16px 0 22px">Add six drinks<br>to your ticket.</h1><p style="color:#c8baa4;line-height:1.7">${escapeHtml(displayName)}, your NOCTURNE digital ticket is active. The optional Six-Drink Package can be added to that ticket now.</p><div style="margin:28px 0;padding:18px;border-left:2px solid #d89a2b;background:#020202;color:#d8c7ac;line-height:1.8"><strong>Package:</strong> Six prepaid drink credits<br><strong>Price:</strong> ${escapeHtml(price)}<br><strong>Beer / well:</strong> One credit<br><strong>Premium:</strong> One credit + $5 at the bar<br><strong>Activation:</strong> Valid 21+ photo ID required</div><p style="text-align:center;margin:30px 0"><a href="${escapeHtml(ticketUrl)}" style="display:inline-block;padding:14px 20px;background:#d89a2b;color:#0b0803;text-decoration:none;font-size:12px;letter-spacing:2px;text-transform:uppercase">Open Ticket &amp; Add Package</a></p><p style="color:#ffca61;font-size:12px;line-height:1.7"><strong>Refund policy:</strong> Refundable only before the first drink credit is redeemed. Once any drink is redeemed, the entire package is non-refundable and no prorated refund is available.</p><div style="margin-top:34px;padding-top:20px;border-top:1px solid rgba(216,154,43,.18);color:#74695b;font-size:11px;letter-spacing:1px;text-transform:uppercase">NOCTURNE Festival · Presented by Wild Ones · Hawai‘i</div></div></div></body></html>`;
