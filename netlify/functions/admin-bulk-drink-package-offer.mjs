...
const APPLICATION_STORE='nocturne-applications',REVIEW_STORE='nocturne-application-reviews',ORDER_STORE='nocturne-ticket-orders',EMAIL_EVENT_STORE='nocturne-email-events',SESSION_COOKIE='nocturne_admin',CAMPAIGN_VERSION='v5';
